...
img = Image.new("1", (380, 225))
img.paste(robo, (0, 0))
paste(img, 150, 75, [abu, canfd])
draw = ImageDraw.Draw(img)
font1 = ImageFont.truetype(dir + "impact.ttf",  75)
font2 = ImageFont.truetype(dir + "impact.ttf",  40)
draw.text((140, 0), name, fill="white", font=font1)
draw.text((140, 78), detail, fill="white", font=font2)
draw.text((140, 113), detail2, fill="white", font=font2)

img.show()
img.save(dir + "logo_USB2CANFD.jpg")
